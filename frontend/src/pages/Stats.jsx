 ...
 function Stats() {
  return (
    <div className="bg-[#f4f1ea] min-h-screen flex flex-col items-center p-6">
      ...
      {/* Chart Section */}
      <div className="bg-[#d6d2c4] p-4 rounded-xl shadow-lg w-full max-w-3xl flex justify-center mb-6">
        <img src="/chart-placeholder.png" alt="Living Planet Index Chart" className="rounded-lg" />
      </div>

      {/* Key Insights */}
      <div className="bg-[#d6d2c4] p-6 rounded-xl shadow-lg w-full max-w-3xl">
